...
class Commands extends Controller
{
     ...
     * )
     */
    public function postCreateHistoryClothes(Request $request){
        try{
     ...
     * )
     */
    public function postCreateClothes(Request $request){
        try{
            $user_id = $request->user()->id;
            ...
            if ($validator->fails()) {
                ...
                if(!$is_exist){
                    ...
                    if($res){
                        ...
                        // Send email
                        dispatch(new ProcessJob('Create clothes', $res, $user->username, $user->email));
     ...
     * )
     */
    public function putRecoverClothesByID(Request $request, $id){
        try{
            $user_id = $request->user()->id;
