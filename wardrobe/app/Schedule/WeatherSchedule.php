    ...
    public static function weather_routine_fetch()
    {
        try{
            ...
            if($user){
                ...
                foreach ($user as $dt) {
                    // Get local weather using user coordinate
                    ...
                    // Create user weather
                    $res = UserWeatherModel::createUserWeather([
                    ...
                    if ($res) {
                        ...
                        if($dt['firebase_fcm_token']){
                            ...
                            $message_fcm = CloudMessage::withTarget('token', $dt['firebase_fcm_token'])->withNotification(Notification::create($message, $res->id));
